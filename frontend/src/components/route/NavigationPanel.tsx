...
const styles = StyleSheet.create({
  ...
  immersiveBottomFull: { position: 'absolute', bottom: 0, left: 0, right: 0, backgroundColor: '#1e293b', borderTopLeftRadius: 20, borderTopRightRadius: 20, paddingHorizontal: 16, paddingTop: 14, zIndex: 100 },
  ...
  immersiveQuickBtn: { flex: 1, height: 54, borderRadius: 12, backgroundColor: 'rgba(255,255,255,0.06)', justifyContent: 'center', alignItems: 'center', gap: 2, marginHorizontal: 3 },
  immersiveQuickLabel: { fontSize: 10, fontWeight: '600', color: '#94a3b8', letterSpacing: 0.3 },
